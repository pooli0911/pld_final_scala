file:///D:/pldfinal/src/main/scala/controllers/SheetController.scala
### java.lang.AssertionError: assertion failed: position error, parent span does not contain child span
parent      = new Cell(3, 3, null) # -1,
parent span = <261..1126>,
child       = null # -1,
child span  = [275..1128..1128]
...
action parameters:
uri: file:///D:/pldfinal/src/main/scala/controllers/SheetController.scala
text:
```scala
package controllers
import models.User
...
import models.{Sheet, Editable}
import models.Cell

class SheetController(){
    val userController = new UserController()
    private val cells = new Cell(3, 3, "0)
    ...
    def createSheet(name:String, ownerName:User): Unit = {
        ...
        val sheet = Sheet(id, name, ownerName, cells, Map(ownerName -> Editable))
        sheets += (id -> sheet)        
   ...
   def printSheet(sheetId: String): Unit = {
        sheets.get(sheetId) match{
            case Some(sheet) => println(sheet.cells.values.mkString("\n"))
